...
generate-runtime-api-clients:
	curl https://dlthub.dev/api/api/schema/openapi.yaml -o tools/runtime_clients/api.openapi.yaml
	...
	curl https://dlthub.dev/api/auth/schema/openapi.yaml -o tools/runtime_clients/auth.openapi.yaml
